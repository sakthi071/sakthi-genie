...
function Homefooter(props) {
    return (
        <Row style={{backgroundColor:"black",marginTop:"1rem"}}>
            <hr/>
            <Col style={{display:"flex",justifyContent:"space-evenly",color:"white",fontSize:"1rem",fontFamily: "TimesNewRoman",marginTop:"1%",
    fontWeight: "lighter"}}>
            <p>About us</p>
            <p>UC Impact</p>
    ...
    flexWrap: "wrap",padding:"10px"}}>
            ...
            <Row style={{color:"grey",padding:"10px"}}>
                ...
                <Row>
                    <Row>
                  <Col lg={2}></Col>
                  <Col lg={3} style={{color:"white"}}>© 2014-20   HomeGeine   Technologies India Pvt. Ltd.</Col>
